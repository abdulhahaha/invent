...
<script>
    ...
    @if ($errors->any())
        Swal.fire({
            icon: 'error',
            title: 'Login Gagal',
            text: '{{ $errors->first() }}', // hanya tampilkan error pertama
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">SIMI</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to SIMI 👋</h4>
